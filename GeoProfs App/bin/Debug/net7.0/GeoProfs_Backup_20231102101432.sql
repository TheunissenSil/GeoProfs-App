...
INSERT INTO `__efmigrationshistory` VALUES ('20230524094009_users','7.0.5'),('20230525174103_InitialCreate','7.0.5'),('20230527121700_IdentityTables','7.0.5'),('20230614191234_CustomApplicationUser','7.0.5'),('20230621085431_createVerlofafaanvragen','7.0.5'),('20230621094049_addDiffrentReason','7.0.5'),('20231026072456_AddFilePathToVerlofaanvraag','7.0.12');
...
INSERT INTO `aspnetuserroles` VALUES ('5752a81d-96b9-4a5e-8aaa-ed875fa36e4e','e8e51715-03b9-464f-8bab-152cec13d976'),('72e1780d-b6d3-4ebf-8d83-1788f96de42b','7520c289-d6b2-4cfa-89f9-49ec2a118670'),('da7bc3ad-7fa6-4fe6-a693-c7ecfba69e7c','e8e51715-03b9-464f-8bab-152cec13d976');
...
CREATE TABLE `verlofaanvragen` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_Verlofaanvragen_UserId` (`UserId`),
  CONSTRAINT `FK_Verlofaanvragen_AspNetUsers_UserId` FOREIGN KEY (`UserId`) REFERENCES `aspnetusers` (`Id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `verlofaanvragen` VALUES ('e8241bb9-451e-4e58-b503-7e0d2fb3d08d','72e1780d-b6d3-4ebf-8d83-1788f96de42b','Vakantie','2023-11-03 00:00:00.000000','2023-11-10 00:00:00.000000','pending','null','');
...
-- Dump completed on 2023-11-02 10:14:32
